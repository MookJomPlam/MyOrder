...
<header>
    ...
    <div class="content">
        ...
        ?>
            ...
            <?php 
                $select_view = 
                "SELECT *,sum(t.p_price) as sumprice,count(o.product_id) as num FROM id18837104_loginadminuser.orders o
                right join id18837104_loginadminuser.tbl_product t 
                on o.product_id=t.p_id where o.user_id=$url group by o.product_id";
