...
<html>
                ...
                <?php $url_id = $_GET['id']; //158
                  ...
                  <div class="cart-total">
                      ...
                      <?php
                        ...
                        //เลือก tbl_user จากฐานข้อมูล หา id = ตัวแปร $_GET['id']"
                        $tbl_user="SELECT * from tbl_user WHERE id=$getid"; 
                        //รันคำสั่ง SQL จากตัวแปร  $tbl_user และใช้การเชื่อมต่อฐานข้อมูลจากตัวแปร $conn
                        $querytbl_user = mysqli_query($conn, $tbl_user);
                        //นำตัวแปร $querytbl_user มาวน Loop 
  ...
  <section class = "products"> 
    <div class = "container"> 
      ...
      <div class = "product-list"> 
        ...
        <?php 
          $id = $_GET['id'];  //294*
          //เลือก tbl_product จากฐานข้อมูล"
          $select_tbl = "SELECT * FROM tbl_product where p_status = 1";
          //รันคำสั่ง SQL จากตัวแปร $select_tbl และใช้การเชื่อมต่อฐานข้อมูลจากตัวแปร $conn
          $run_tbl = mysqli_query($conn, $select_tbl);
          //นำตัวแปร $run_tbl มาวน Loop 
      ...
      <!-- กดสั่งซื้อ ตัวเดียวกับ ลบ 141-->
            <?php
                $add_cart = $_GET['id']; 
                //เลือก tbl_product จากฐานข้อมูล หา id = ตัวแปร $_GET['id'] "
                $add_cart2 = "SELECT * from tbl_user WHERE id=$add_cart";
                //รันคำสั่ง SQL จากตัวแปร $add_cart2 และใช้การเชื่อมต่อฐานข้อมูลจากตัวแปร $conn
                $add_cart3 = mysqli_query($conn,$add_cart2);
                 //นำตัวแปร $$add_cart3 มาวน Loop 
                while ($row = mysqli_fetch_array($add_cart3)) {
                  $add_cart4 = $row['cartstatus'];

                  if($add_cart4 == 0){ //ถ้า ตัวแปร $add_cart4 = 0 จะแสดง
  ...
  <footer>
    <div class = "footer-banner"> 
      <div class = "container"> 
        <h2> ติดต่อ </h2>
          <p class = "text">ที่อยู่: หมู่ 4 เลขที่ 134 ระหว่างปั๊มปตทคลองหกและเดอะพอย์ทคอนโด  
            ถนน รังสิต - นครนายก อำเภอธัญบุรี ปทุมธานี 12110
            เวลาทำการ: 
            <br>     
  ...
  <script>
      ...
      let click = document.querySelector('.click'); //ค่าที่เจอใน document  Class="click"

      let list = document.querySelector('.list-order'); //ค่าที่เจอใน document  Class="list-order"

      click.addEventListener("click",()=>{ //แนบเหตุการณ์ เมื่อผู้ใช้คลิก
